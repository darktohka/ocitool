...
fn main() {
    ...
    config.out_dir("src/compose/containerd/proto");
...
fn fixup_imports(path: &str) -> Result<(), io::Error> {
    let out_dir = "src/compose/containerd/proto";
    let path = format!("{}/{}.rs", out_dir, path);

    let contents = fs::read_to_string(&path)?
        .replace(
            "super::super::super::v1::types",
            "crate::compose::containerd::client::types::v1",
        ) // for tasks service
        .replace(
            "super::super::super::super::types",
            "crate::compose::containerd::client::types",
        )
        .replace(
        ...
        .replace(
            "super::super::super::super::google",
            "crate::compose::containerd::client::google",
        )
        .replace(
